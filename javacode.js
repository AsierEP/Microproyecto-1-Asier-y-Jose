...
public class Palabras {
    ...
    //obtener una palabra al azar de la lista
    public static String obtenerPalabraAlAzar() {
    ...
    public static void main(String[] args) {
        String palabra = obtenerPalabraAlAzar();
        System.out.println("Palabra seleccionada al azar: " + palabra);
    }
}
